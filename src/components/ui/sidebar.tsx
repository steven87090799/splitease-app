  ...
  (
    ...
    return (
      ...
      >
        <div
          className={cn(
            "duration-200 relative h-svh bg-card transition-[width] ease-linear",
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        state === 'collapsed' && "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0",
        className
      )}
      {...props}
    />
